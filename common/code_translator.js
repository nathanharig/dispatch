function makeCodes() {
	let codes = {
		...
		'od/poisoning': 'DNS',
		'od/poisoning aed': 'Reported overdose patient who needs CPR/AED',
		'obstetrics': 'DNS',//'a reported obstetrical emergency',
		...
		't/a' : 'Reported vehicle crash',
		'a/a' : 'Reported vehicle crash',
		'a/a entrapment/high mechanism' : 'Reported vehicle crash',
		'a/a high mech/entrapment' : 'Reported vehicle crash',
		...
		'a/a entrapment/high mechanism' : 'Reported vehicle crash',
		'a/a entrapment w/ fire large' : 'Reported vehicle crash with fire',
		'a/a entrapment w/ fire small' : 'Reported vehicle crash with fire',
		'a/a veh vs bldg w/ injuries' : 'Reported auto/building collision',
		'a/a veh vs bldg no injuries' : 'Reported auto/building collision, no injuries reported',
		'a/a unk injuries': 'Reported vehicle crash',
		'vehicle accident w/ hazmat' : 'Reported vehicle crash with hazmat',
		'a/a w/ hazmat' : 'Reported vehicle crash with hazmat',
