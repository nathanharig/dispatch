function makeCodes() {
	let codes = {
		...
		'allergies / stings / bites': 'DNS',//'a reported allergic reaction',
		...
		'burn / explosion': 'Reported injury involving a burn or explosion ',
		'carbon monoxide / inhalation / hazmat / cbrn ': 'Reported HAZMAT or CO incident',
		'cardiac or respiratory arrest / death ': 'Reported patient in cardiac arrest',
		'chest pain': 'DNS',//'a reported chest pain patient',
		'choking': 'Reported choking patient',
		'seizures / convulsions': 'DNS',//'a reported seizure patient',
		'diabetic': 'DNS',//'a reported diabetic emergency',
		'drowning / diving / scuba accident ': 'Reported patient with a drowning or diving emergency',
		'electrocution / lightning ': 'Reported electrocution or lightning strike',
		'eye problem / injuries': 'DNS',//'a reported eye injury',
		'fall victim': 'DNS',//'a reported fall victim',
		'headache': 'DNS',//'a reported headache',
		'heart problem': 'DNS',//'a reported cardiac problem',
		'heat / cold exposure': 'Reported environmental emergency',
		'hemorrhage / laceration': 'DNS',
		...
		'traumatic injuries ': 'Reported injury',
		'unconscious person': 'DNS',//'a reported unconscious person',
		'unknown problem': 'An unknown problem',
		...
		'structure fire - large other' : 'Reported structure fire',
		...
		'high mechanism/entrapment' : 'Reported vehicle crash',
		'entrapment w/ fire large' : 'Reported vehicle crash with fire',
		'entrapment w/ fire small' : 'Reported vehicle crash with fire',
		'vehicle vs bldg w/ injuries' : 'Reported auto/building collision',
		'vehicle vs bldg no injuries' : 'Reported auto/building collision, no injuries reported',
